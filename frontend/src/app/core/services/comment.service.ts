...
export class CommentService {
    ...
    delete(id: String,slug:String): Observable<any> {
        return this.http.delete<any>(`${URL}/${id}/${slug}`);
    }
    ...
    destroy(id: String,slug:String) {
        // return this.apiService.delete(`comments/${id}`);
        return this.apiService.delete(`comments/${slug}/${id}`);
    }
}